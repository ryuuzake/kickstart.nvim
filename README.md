...
> [!NOTE]
> If you've forked this repo, replace `ryuuzake` with your GitHub username in the commands below

<details><summary> Linux and Mac </summary>

```sh
git clone https://github.com/ryuuzake/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/ryuuzake/kickstart.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/ryuuzake/kickstart.nvim.git "${env:LOCALAPPDATA}\nvim"
```
